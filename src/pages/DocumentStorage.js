...
function DocumentStorage() {
  ...
  return (
    <div className="page">
      ...
      <p className="page-subtitle">Photos and files for your policies, receipts, inspections, and warranties.</p>
        ...
        {filtered.map((doc) => (
          <div key={doc.id} className="doc-card card">
            ...
            <div className="doc-info">
              ...
              <span className="doc-meta">{doc.type} - {doc.date} - {doc.size}</span>
            </div>
